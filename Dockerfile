...
ENV MOPIDY_VERSION 3.1.1-1
ENV MOPIDY_LOCAL_VERSION 3.2.0-1
ENV MOPIDY_MPD 3.1.0-1
ENV MOPIDY_SOMAFM 2.0.1-1
ENV MOPIDY_SCROBBLER 2.0.1-1
ENV MOPIDY_SOUNDCLOUD 3.0.1-1
ENV MOPIDY_TUNEIN 1.1.0-1
ENV MOPIDY_MOBILE 1.10.0
ENV MOPIDY_MUSICBOX_WEBCLIENT 3.1.0
ENV MOPIDY_PARTY 1.0.0
ENV MOPIDY_SPOTIFY 4.1.1
ENV IRIS_VERSION 3.57.3
